...
public class AuthenticationUtil {
  ...
  public static Auth getAuthOrReturnNull() {
    UserAuthentication userAuthentication = getAuthentication();
    return (userAuthentication == null) ? null : userAuthentication.getAuth();
  }
}
