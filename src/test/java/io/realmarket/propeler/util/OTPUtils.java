...
import static io.realmarket.propeler.model.enums.AuthorizedActionTypeName.NEW_EMAIL;
...
public class OTPUtils {
  ...
  public static OTPWildcard TEST_OTP_WILDCARD_1() {
    return OTPWildcard.builder().wildcard(TEST_OTP_WILDCARD_1).auth(TEST_AUTH).build();
  }

  public static OTPWildcard TEST_OTP_WILDCARD_2() {
    return OTPWildcard.builder().wildcard(TEST_OTP_WILDCARD_2).auth(TEST_AUTH).build();
  }
